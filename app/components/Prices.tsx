...
const Prices = () => {
  return (
    <div className="lg:items-center py-8 lg:px-10">
      ...
      {/* mobile menu */}
      <table className="lg:hidden border w-full overflow-hidden text-lg">
        <tbody>
          <tr className="border-b ">
            <th scope="row" className="pr-12 py-4 font-light whitespace-nowrap">
              <Link href="#" className="flex space-x-2 items-center">
                <FaBitcoin size={32} className="text-orange-400" />
            ...
            <td className="pl-16 pr-4 pt-4 flex font-light flex-col text-end">
              <span>KES 3,766,984.77</span>
              <p className=" text-end text-red-600">-0.57%</p>
            </td>
          </tr>
          <tr className="border-b ">
            <th scope="row" className="pr-12 py-4 font-light whitespace-nowrap">
            ...
            <td className="pl-16 pr-4 pt-4 flex font-light flex-col text-end">
              <span>KES 251,489.98</span>
              <p className=" text-end text-red-600">-0.39%</p>
            </td>
          </tr>
          <tr className="border-b ">
            <th scope="row" className="pr-12 py-4 font-light whitespace-nowrap">
            ...
            <td className="pl-16 pr-4 pt-4 flex font-light flex-col text-end">
              <span>KES 49.52</span>
              <p className=" text-end text-red-600">-1.00%</p>
            </td>
          </tr>
          <tr className="border-b ">
            <th scope="row" className="pr-12 py-4 font-light whitespace-nowrap">
